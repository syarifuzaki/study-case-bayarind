...
// Define type for PresetOptions
type PresetOptions = Record<string, typeof Aura | typeof Lara>
...
function getPresetExt(): Record<string, any> {
  const color: any = primaryColors.value.find((c) => c.name === layoutConfig.primary)
...
function updateColors(type: string, color: Color): void {
  if (type === 'primary') {
...
function applyTheme(type: string, color: Color): void {
  if (type === 'primary') {
